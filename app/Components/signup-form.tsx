...
<div className="relative z-0 w-full mb-5 group ">
  ...
  <div className="relative z-0 w-full mb-5 group ">
     ...
     <label className=''>رقم الواتساب </label>
<PhoneInput
country='eg'
value={number}
